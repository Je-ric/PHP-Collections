...
class AddStudent {
    ...
    public function addNewStudent() {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $insert_query = "INSERT INTO students (name, age, email, student_id, gpa) VALUES (?, ?, ?, ?, ?)";
            $stmt = $this->conn->prepare($insert_query);
            $stmt->bind_param("sissd", $name, $age, $email, $student_id, $gpa);
            ...
            if ($stmt->execute()) {
                ...
                $this->insert_error = "Insertion failed";
            }
...
$addStudent = new AddStudent($conn);
