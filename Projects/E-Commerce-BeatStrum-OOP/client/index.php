...
class ItemManager {
    ...
    public function getItems($itemsPerPage, $page, $searchQuery = '', $sort = 'name') {
        $offset = ($page - 1) * $itemsPerPage;
        $searchCondition = '';
        
        if (!empty($searchQuery)) {
            $searchCondition = "WHERE items.name LIKE '%$searchQuery%'";
        }
...
$result = $itemManager->getItems($items_per_page, $page, $search_query, $sort);
?>
...
<head>
    ...
    <style>
        <?php include('C:\xampp\htdocs\PHP-Projects\E-Commerce-BeatStrum-OOP\css\index_client.css'); ?>
    </style>
   <script src="/PHP-Projects/E-Commerce-BeatStrum-OOP/script/search_index.js"></script>
</head>
<body>
...
<div>
    <a href="index.php"><img src="/PHP-Projects/E-Commerce-BeatStrum-OOP/images/svg/logo-no-background.svg" alt=""></a></li>
</div>
...
<div class="discover">
        ...
        <?php
         $sql_count = "SELECT COUNT(*) AS total_items FROM items $search_query"; //search_condition
