...
<head>
    ...
    <style>
        <?php include('C:\xampp\htdocs\PHP-Projects\E-Commerce-BeatStrum-OOP\css\cart.css'); ?>
    </style>
</head>
<body>    
<?php include ('1.header.php'); ?>
    ...
    <script src="/PHP-Projects/E-Commerce-BeatStrum-OOP/script/shopping_cartTab.js"></script>
