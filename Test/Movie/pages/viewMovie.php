                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-text-secondary">
                                    <?php if (!empty($directors)): ?>
                                        <?php
                                            $dirLinks = array_map(function($d) {
                                                $name = htmlspecialchars($d['name']);
                                                $pid = (int)($d['person_id'] ?? 0);
                                                return $pid > 0
                                                    ? "<a class=\"link link-hover text-accent\" href=\"castMovie.php?person_id={$pid}\">{$name}</a>"
                                                    : $name;
                                            }, $directors);
                                            echo implode(' • ', $dirLinks);
                                        ?>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?>
                            ...
                            <div>
                                ...
                                <p class="text-text-secondary">
                                    <?php if (!empty($actors)): ?>
                                        <?php
                                            $castLinks = array_map(function($a) {
                                                $name = htmlspecialchars($a['name']);
                                                $pid = (int)($a['person_id'] ?? 0);
                                                return $pid > 0
                                                    ? "<a class=\"link link-hover text-accent\" href=\"castMovie.php?person_id={$pid}\">{$name}</a>"
                                                    : $name;
                                            }, $actors);
                                            echo implode(' • ', $castLinks);
                                        ?>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?>
